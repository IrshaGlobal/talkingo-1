      ...
      <div className="w-full max-w-sm bg-card border border-border/50 rounded-3xl shadow-2xl animate-slide-up overflow-hidden max-h-[95vh] overflow-y-auto">
        ...
        <div className="px-5 pb-5 space-y-4">
          ...
          <ShimmerButton
            ...
            disabled={loading}
            shimmerColor="hsl(14, 92%, 56%)"
            background="hsl(14, 88%, 48%)"
            className="w-full py-3 rounded-2xl text-white font-bold text-sm shadow-lg shadow-primary/25 flex items-center justify-center gap-1.5 disabled:opacity-60 disabled:cursor-not-allowed"
          >
