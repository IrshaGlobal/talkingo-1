...
import { getCompletedLessons } from '@/lib/storage/lesson-progress'
import type {
      ...
      <div className="relative z-10 flex-shrink-0 px-4 sm:px-6 pt-3 pb-2 max-w-lg mx-auto w-full">
        <motion.div initial={{ opacity: 0, y: -6 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <div className="flex items-center gap-1 px-2 py-1 rounded-lg bg-card border border-border/40 text-muted-foreground">
        ...
        <div className="max-w-lg mx-auto w-full space-y-4 pb-24">
          ...
          <div className="mb-2 space-y-2.5">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 rounded-xl border border-border/40 bg-card text-sm focus:outline-none focus:border-primary/40 focus:shadow-[0_0_20px_-6px_hsl(var(--primary)/0.12),0_0_8px_-2px_hsl(var(--primary)/0.08)] placeholder:text-muted-foreground/40 shadow-sm transition-all duration-200"
              />
            </div>
                ...
                <motion.button
                  ...
                  className={cn(
                    ...
                    levelFilter === level
                      ...
                      : 'bg-card/80 text-muted-foreground border-border/40 hover:border-border/60'
                  )}
                >
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          grammarFilter === tag
                            ...
                            : 'bg-card/60 text-muted-foreground/70 border-border/30 hover:border-border/50'
                        )}
                      >
                        {label}
                      </button>
                ...
                {grammarFilter && (
                  <div className="flex items-center gap-1.5 px-1">
                    ...
                    <button
                      ...
                      className="text-[9px] text-muted-foreground/50 hover:text-foreground underline"
                    >
                      Clear
                    </button>
                  </div>
          ...
          {!scenariosLoading && filteredLevels.length === 0 && (
            <div className="text-center py-16">
              ...
              <p className="text-sm text-muted-foreground font-medium">No levels match your filters</p>
          ...
          {/* Level sections */}
          {!scenariosLoading && filteredLevels.map(({ level, filtered, completed, total }) => {
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="w-full text-left px-4 py-3.5 hover:bg-card-elevated/50 transition-colors"
                >
                    ...
                    >
                      <div className="px-4 pb-3 border-t border-border/20">
                        ...
                        <div className="space-y-1.5 mt-2">
                          {filtered.map((scenario: CachedScenario) => {
                            ...
                            return (
                              ...
                              >
                                {isDone ? (
                                  ...
                                  <Circle className="w-4 h-4 text-border/40 flex-shrink-0" />
                                )}
                                <span className={cn(
                                  'flex-1 text-xs font-semibold min-w-0',
                                  isDone ? 'text-muted-foreground/70' : 'text-foreground'
                                )}>
                                  {scenario.title}
                                </span>
                                <span className={cn(
          ...
          {!scenariosLoading && filteredLevels.length > 0 && (
            <p className="text-center text-[10px] text-muted-foreground/30 pt-2 font-medium">
              {totalCompleted}/{TOTAL_SEEDS} completed &middot; {allMatchCount} topics shown
            </p>
          )}
